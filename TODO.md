...
- [x] Update Admin FAQ Management: Modify `/admin/faq` route to order FAQs by frequency descending and display frequency in the template.
- [x] Update Public FAQ Page: Modify `/faq` route to order FAQs by frequency descending.
- [x] Create Missing Templates: Create `admin_faq.html` for admin management (with frequency display and edit capabilities) and `faq.html` for public viewing.
